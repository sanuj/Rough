...
public class GetAddressTask extends AsyncTask<Location, Void, String> {
	...
	public GetAddressTask(Activity context) {
	...
	protected String doInBackground(Location... params) {
		...
		try {
			...
			String errorString = "illegal_argument_exception";/*
															 * getString(
															 * R.string.
		...
		if (addresses != null && addresses.size() > 0) {
			...
			String addressText = activity.getString(
			...
			return activity.getString(R.string.no_address_found);
		}
	}
	...
	protected void onPostExecute(String address) {
		...
		((ActivityFindCarNear)activity).setAddressResponse(address);
	}
}
