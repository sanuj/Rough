...
public class DateTimePicker implements OnClickListener {
	...
	public View getDateTimePickerLayout() {
		...
		View inflatedView = mInflater.inflate(R.layout.dialog_date_time, null);
		btnSet = (Button) inflatedView.findViewById(R.id.button_set);
		btnCancel = (Button) inflatedView.findViewById(R.id.button_cancel);
		datePicker = (DatePicker) inflatedView.findViewById(R.id.datePicker1);
		timePicker = (TimePicker) inflatedView.findViewById(R.id.timePicker1);
